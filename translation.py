...
ɪ ᴀᴍ ᴀ ᴘᴏᴡᴇʀғᴜʟ ᴀᴅᴠᴀɴᴄᴇ ᴜʀʟ ᴜᴘʟᴏᴀᴅᴇʀ ʙᴏᴛ ғᴏʀ ᴀɴɪᴍᴇ ᴍᴀɴɪᴀ.

ɢɪᴠᴇ ᴍᴇ ᴀɴʏ ʟɪɴᴋ ɪ ᴡɪʟʟ ᴜᴘʟᴏᴀᴅ ɪɴᴛᴏ ғɪʟᴇ ᴏʀ ᴠɪᴅᴇᴏ ᴡɪᴛʜ ᴄᴜsᴛᴏᴍ ᴛʜᴜᴍʙɴᴀɪʟ sᴜᴘᴘᴏʀᴛ.

ᴛʜɪs ʙᴏᴛ ɪs ᴘᴏᴡᴇʀᴇᴅ ʙʏ <a href="https://t.me/Anime_Mania_0">ᴀɴɪᴍᴇ ᴍᴀɴɪᴀ</a></b>
"""

    TECH_VJ_HELP_TEXT = """
<b>🖍️ ғᴇᴀᴛᴜʀᴇs :-

🔺 ᴜᴘʟᴏᴀᴅ ʏᴛ-ᴅʟᴘ sᴜᴘᴘᴏʀᴛᴇᴅ ʟɪɴᴋs</a> ᴛᴏ ᴛᴇʟᴇɢʀᴀᴍ.
...
"""
    ...
    TECH_VJ_ABOUT_TEXT = """
<b>♻️ ᴍʏ ɴᴀᴍᴇ : ᴍᴀɴɪᴀ ᴜᴘʟᴏᴀᴅᴇʀ ʙᴏᴛ

🌀 ᴄʜᴀɴɴᴇʟ : <a href="https://t.me/Anime_Mania_0">ᴀɴɪᴍᴇ ᴍᴀɴɪᴀ</a>
...
👲 ᴅᴇᴠᴇʟᴏᴘᴇʀ : <a href="https://t.me/rai_yan_00">Rᴀɪ Yᴀɴ</a></b>
...
"""
    ...
    TECH_VJ_START_BUTTONS = InlineKeyboardMarkup(
        [[
            InlineKeyboardButton('ᴍᴀɪɴ ᴄʜᴀɴɴᴇʟ', url='https://t.me/anime_mania_0')
        ], [
            InlineKeyboardButton('ᴏᴡɴᴇʀ', url='https://t.me/rai_yan_00'),
            InlineKeyboardButton('ᴍᴀɴɢᴀ ᴄʜᴀɴɴᴇʟ', url='https://t.me/manga_mania_0')
        ], [
            InlineKeyboardButton('❓ ʜᴇʟᴘ', callback_data='help'),
            InlineKeyboardButton('🦊 ᴀʙᴏᴜᴛ', callback_data='about')
        ], [
            InlineKeyboardButton('ғᴏʟʟᴏᴡ ᴏɴ ɪɴsᴛᴀɢʀᴀᴍ', url='https://instagram.com/being_rai_yan')
        ]]
    )
